 ...
 return <div className={s.app}>
  ...
  <div className={s.layout}>
   ...
   <main className={s.main}>
    ...
    <footer className={s.footer}><strong>빈집진단서 · 집토끼 돌봄</strong><details><summary>시제품 구현 범위</summary><p>방문 보고·추가 작업 승인·문의는 현재 페이지 메모리에서 연결됩니다. 실제 로그인, 결제, 서버 저장, 알림 전송, AI 호출은 연결하지 않았습니다. 사진은 서버로 전송하지 않습니다. 고객·현장 역할 전환은 인증 기능이 아닙니다.</p></details></footer>
   </main>
  </div>
 </div>
}
